...
function addressKindChange(e){
    ...
    var target = document.getElementById("select_value2");

    if(e.value == '108') var d = seoul;
    else if (e.value == '184') var d = jeju;
    else if (e.value == '159') var d = pusan;
...
var myBarChart = new Chart(ctx, {
  ...
  smalllocal = $("#select_value2 > option:selected").attr("value");
  console.log(smalllocal); //test = 마포구
  ...
  success: function(data){
      ...
      document.getElementById("selectedlocal").innerHTML = showlocal;
